...
#include "aw9106-led1.h"
/******************************************************
 *
 * Marco
 *
 ******************************************************/
#ifdef NUBIA_LED1_AW9106
#define AW9106_I2C_NAME "aw9106_led1"
#else
...
#ifdef NUBIA_LED1_AW9106
#define AW9106_PINCTRL_STATE_ACTIVE "aw9106_led1_default"
#define AW9106_PINCTRL_STATE_SUSPEND "aw9106_led1_sleep"
#endif
...
#ifdef NUBIA_LED1_AW9106
const unsigned char aw9106_led1_reg_access[AW9106_REG_MAX] = {
...
#ifdef NUBIA_LED1_AW9106
		if (!(aw9106_led1_reg_access[i]&REG_RD_ACCESS))
#else
